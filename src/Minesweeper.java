...
public class Minesweeper {
    public static void main(String[] args) throws Exception {
        ...
        int opt; String jogada; String[] jogadaArray; String acao = ""; int linha = 0; int coluna = 0;
        while (true) { 
            System.out.println();
            ...
            if (opt == 0){
                System.out.println("Certo, encerrando o sistema agora...");
                break;
            }
            
            switch (opt){
                case 1:
                    Tabela tab = new Tabela(8,8);
                    tab.imprimir();
